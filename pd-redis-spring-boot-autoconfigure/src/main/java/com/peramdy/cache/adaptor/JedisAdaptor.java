package com.peramdy.cache.adaptor;
...
/**
 * @author peramdy on 2018/2/8.
 */
public class JedisAdaptor extends Jedis implements MethodInterceptor {

    private Logger logger = LoggerFactory.getLogger(JedisAdaptor.class);
    private Jedis jedis;


    private void proxy(Class[] argumentTypes, Object[] arguments) {
        Enhancer enhancer = new Enhancer();
        enhancer.setSuperclass(Jedis.class);
        enhancer.setCallback(this);
        jedis = (Jedis) enhancer.create(argumentTypes, arguments);
    ...
    public JedisAdaptor() {
        super();
        proxy(new Class[]{}, new Object[]{});
    }

    public JedisAdaptor(String host) {
        super(host);
        proxy(new Class[]{String.class}, new Object[]{host});
    }

    public JedisAdaptor(String host, int port) {
        super(host, port);
        proxy(new Class[]{String.class, int.class}, new Object[]{host, port});
    }

    public JedisAdaptor(String host, int port, boolean ssl) {
        super(host, port, ssl);
        proxy(new Class[]{String.class, int.class, boolean.class}, new Object[]{host, port, ssl});
    }

    public JedisAdaptor(String host, int port, boolean ssl, SSLSocketFactory sslSocketFactory, SSLParameters sslParameters, HostnameVerifier hostnameVerifier) {
        super(host, port, ssl, sslSocketFactory, sslParameters, hostnameVerifier);
        proxy(new Class[]{String.class, int.class, boolean.class, SSLSocketFactory.class, SSLParameters.class, HostnameVerifier.class},
                new Object[]{host, port, ssl, sslSocketFactory, sslParameters, hostnameVerifier});
    }

    public JedisAdaptor(String host, int port, int timeout) {
        super(host, port, timeout);
        proxy(new Class[]{String.class, int.class, int.class}, new Object[]{host, port, timeout});
    }

    public JedisAdaptor(String host, int port, int timeout, boolean ssl) {
        super(host, port, timeout, ssl);
        proxy(new Class[]{String.class, int.class, int.class, boolean.class}, new Object[]{host, port, timeout, ssl});
    }

    public JedisAdaptor(String host, int port, int timeout, boolean ssl, SSLSocketFactory sslSocketFactory, SSLParameters sslParameters, HostnameVerifier hostnameVerifier) {
        super(host, port, timeout, ssl, sslSocketFactory, sslParameters, hostnameVerifier);
        proxy(new Class[]{String.class, int.class, int.class, boolean.class, SSLSocketFactory.class, SSLParameters.class, HostnameVerifier.class},
                new Object[]{host, port, timeout, ssl, sslSocketFactory, sslParameters, hostnameVerifier});
    }

    public JedisAdaptor(String host, int port, int connectionTimeout, int soTimeout) {
        super(host, port, connectionTimeout, soTimeout);
        proxy(new Class[]{String.class, int.class, int.class, int.class}, new Object[]{host, port, connectionTimeout, soTimeout});
    }

    public JedisAdaptor(String host, int port, int connectionTimeout, int soTimeout, boolean ssl) {
        super(host, port, connectionTimeout, soTimeout, ssl);
        proxy(new Class[]{String.class, int.class, int.class, int.class, boolean.class},
                new Object[]{host, port, connectionTimeout, soTimeout, ssl});
    }

    public JedisAdaptor(String host, int port, int connectionTimeout, int soTimeout, boolean ssl, SSLSocketFactory sslSocketFactory, SSLParameters sslParameters, HostnameVerifier hostnameVerifier) {
        super(host, port, connectionTimeout, soTimeout, ssl, sslSocketFactory, sslParameters, hostnameVerifier);
        proxy(new Class[]{String.class, int.class, int.class, int.class, boolean.class, SSLSocketFactory.class, SSLParameters.class, HostnameVerifier.class},
                new Object[]{host, port, connectionTimeout, soTimeout, ssl, sslSocketFactory, sslParameters, hostnameVerifier});
    }

    public JedisAdaptor(JedisShardInfo shardInfo) {
        super(shardInfo);
        proxy(new Class[]{JedisShardInfo.class}, new Object[]{shardInfo});
    }

    public JedisAdaptor(URI uri) {
        super(uri);
        proxy(new Class[]{URI.class}, new Object[]{uri});
    }

    public JedisAdaptor(URI uri, SSLSocketFactory sslSocketFactory, SSLParameters sslParameters, HostnameVerifier hostnameVerifier) {
    ...
    public JedisAdaptor(URI uri, int timeout) {
        super(uri, timeout);
        proxy(new Class[]{URI.class, int.class}, new Object[]{uri, timeout});
    }

    public JedisAdaptor(URI uri, int timeout, SSLSocketFactory sslSocketFactory, SSLParameters sslParameters, HostnameVerifier hostnameVerifier) {
        super(uri, timeout, sslSocketFactory, sslParameters, hostnameVerifier);
        proxy(new Class[]{URI.class, int.class, SSLSocketFactory.class, SSLParameters.class, HostnameVerifier.class},
                new Object[]{uri, timeout, sslSocketFactory, sslParameters, hostnameVerifier});
    }

    public JedisAdaptor(URI uri, int connectionTimeout, int soTimeout) {
        super(uri, connectionTimeout, soTimeout);
        proxy(new Class[]{URI.class, int.class, int.class}, new Object[]{uri, connectionTimeout, soTimeout});
    }

    public JedisAdaptor(URI uri, int connectionTimeout, int soTimeout, SSLSocketFactory sslSocketFactory, SSLParameters sslParameters, HostnameVerifier hostnameVerifier) {
        super(uri, connectionTimeout, soTimeout, sslSocketFactory, sslParameters, hostnameVerifier);
        proxy(new Class[]{URI.class, int.class, int.class, SSLSocketFactory.class, SSLParameters.class, HostnameVerifier.class},
                new Object[]{uri, connectionTimeout, soTimeout, sslSocketFactory, sslParameters, hostnameVerifier});
    }
